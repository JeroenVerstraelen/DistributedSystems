...
public interface Hello {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"Hello\",\"namespace\":\"avro.hello.proto\",\"types\":[],\"messages\":{\"sayHello\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"}],\"response\":\"string\"},\"ping\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"}],\"response\":\"null\",\"one-way\":true}}}");
  java.lang.CharSequence sayHello(java.lang.CharSequence username) throws org.apache.avro.AvroRemoteException;
  void ping(java.lang.CharSequence username);
